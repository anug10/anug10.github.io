...
define( "RECIPIENT_NAME", "Ibuku Nursing Wear" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "ibukunursingwear@gmail.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Reseller Inquiery" ); //UPDATE THIS TO YOUR SUBJECT
